...
public class DividerItemDecor extends RecyclerView.ItemDecoration {
    ...
    public DividerItemDecor(Context context) {
    ...
    public DividerItemDecor setPadding(float padding) {
        return setPadding(padding, padding);
    }

    public DividerItemDecor setPadding(float paddingLeft, float paddingRight) {
